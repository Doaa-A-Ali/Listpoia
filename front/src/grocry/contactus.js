...
const Contact = () =>{
    ...
    return(
        <div class="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-green-400 rounded-lg">
            <div class="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                <div>
                    <h1 class="text-4xl font-bold text-green-700">Get in Touch</h1>
                    <p class="text-sm text-green-700 mt-4 leading-relaxed">Have some big idea or brand to develop and need help? Then reach out we'd love to hear about your project  and provide help.</p>
                    ...
                    <ul class="flex mt-12 space-x-4">
                        <li class="bg-orange-500 hover:bg-orange-700 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                ...
                <div class="bg-gray-100 p-6 rounded-lg">
                    <p class="text-sm font-semibold text-gray-800">You have something to say? Tell Us!</p>
                    ...
                    <form class="mt-8 space-y-4">
                        <input type='text' placeholder='Name'
                            class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-orange-500" />
                        <input type='email' placeholder='Email'
                            class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-orange-500" />
                        {/* <input type='text' placeholder='Subject'
                            class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#a91079]" /> */}
                        <textarea placeholder='Message' rows="6"
                            class="w-full rounded-lg px-4 text-gray-800 text-sm pt-3 outline-orange-500"></textarea>
                        <button type='button'
                            class="text-white bg-orange-500 hover:bg-orange-700 tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
